    ...
    public List<Expression> evaluate () throws SlogoException {
        ...
        for (Map.Entry<String, Expression> entry : variables.entrySet()) {
            ...
            if (!model.getFunctionStack().empty()) {
                scopedExpression =
                        (ScopedExpression) model.getRunningFunction().get(model.getFunctionStack()
                                                                                  .peek());
            }
            ...
            // ScopedExpression scopedExpression = (ScopedExpression)
            // model.getRunningFunction().get(model.getFunctionStack().peek());
