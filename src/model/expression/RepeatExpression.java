...
public class RepeatExpression extends ScopedExpression {
    ...
    public void convert (List<String> cmdList) throws SlogoException {
        ...
        // expression1 = DefaultParser.parse(new ArrayList<String>(cmdList.subList(0,
        // openBracketIndex)));

        List<String> expression2CmdList =
    ...
    /*
     * @Override
     * // Must think about whether expressions being evaluated can check for variables defined
     * outside of repeat scope!
    ...
    public List<TurtleCommand> createTurtleCommands (TurtleCommand turtleCmd) throws SlogoException {
        ...
        NumberExpression repeatNumberExp = (NumberExpression) variableExpression.evaluate().get(0); // Assume
                                                                                                    // variable
                                                                                                    // is
                                                                                                    // NumberExpression
