 ...
 * application.
 */
public class DefaultTurtleDisplay extends TurtleDisplay {
        public DefaultTurtleDisplay(Controller controller) {
        ...
        public DefaultTurtleDisplay(JGPoint size, Controller controller) {
